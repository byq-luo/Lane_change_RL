...
MAKELOG=$PREFIX/${FILEPREFIX}make.tf_events
MAKEALLLOG=$PREFIX/${FILEPREFIX}makealloptions.tf_events
STATUSLOG=$PREFIX/${FILEPREFIX}status.tf_events
TESTLOG=$PREFIX/${FILEPREFIX}test.tf_events
